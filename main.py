...
Window.clearcolor = (.20, .10, .20, 1)
btn_color = (.10, .50, .80, 1)
...
class PulseScr(Screen):
    def __init__(self, **kwargs):
        ...
        instr = ScrollLabel(txt_test1, textcolor = '#00FF00')
        lbl1 = ScrollLabel('Считайте пульс', textcolor = '#FF00FF')
        self.lbl_sec = Seconds(15, textcolor = '#FFFF00')
...
class CheckSits(Screen):
    def __init__(self, **kwargs):
        ...
        instr = ScrollLabel(txt_sits, size_hint=(0.3, 1), textcolor = '#F0FF0F')
        lbl1 = ScrollLabel('Сделайте 30 приседаний', textcolor = '#0FFFF0')
...
class PulseScr2(Screen):
    def __init__(self, **kwargs):
        ...
        self.lbl1 = ScrollLabel('Считайте пульс', textcolor = '#F0F0FF')
        self.lbl_sec = Seconds(15, textcolor = '#0FFFFF')
        self.lbl_sec.bind(done=self.sec_finished)
...
class Result(Screen):
    def __init__(self, **kwargs):
        ...
        self.instr = ScrollLabel('', textcolor = '#FF00FF')
